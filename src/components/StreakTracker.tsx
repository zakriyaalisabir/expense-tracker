  ...
  return (
    ...
    >
      <CardContent sx={{ textAlign: "center" }}>
        <Box sx={{ color: isActive ? "primary.main" : "grey.500", mb: 1, fontSize: 32 }}>
          {streakIcons[streak.streak_type]}
        </Box>
        ...
        <Chip label={`Best: ${streak.best_count}`} size="small" variant="outlined" sx={{ mt: 1 }} />
    ...
    <Card>
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
          <Typography variant="h6">Streak Tracker</Typography>
